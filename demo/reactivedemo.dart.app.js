...
Observable.count = function(source) {
  var cnt = (0);
  return Observable.create((function (o) {
    return source.subscribe((function (_) {
      return ++cnt;
    })
    , (function () {
      o.next(cnt);
...
Observable.timer = function(milliseconds, ticks, continuation) {
  if (milliseconds < (1)) return Observable.throwE(const$0004);
  return Observable.create((function (o) {
    function makeit() {
      if (ticks <= (0)) {
...
_ChainableIObservableImplementation.prototype.count = function() {
  return Observable.count(this);
}
...
reactivedemo.prototype.timer = function() {
  var status = html_get$document().query("#status");
  var counter = (0);
...
reactivedemo.prototype.fromEvent = function() {
  var button = html_get$document().query("#btnClickDemo");
  var buttonStatus = html_get$document().query("#btnStatus");
  Observable.fromEvent(button.get$on().get$click()).count().subscribe$1((function (c) {
    var $0;
...
(function(){
  ...
  var v3/*Uint8Array*/ = 'Uint8Array|Uint8ClampedArray';
...
var const$0004 = Object.create(ObservableException.prototype, {message: {"value": "Invalid milliseconds value.", writeable: false}});
