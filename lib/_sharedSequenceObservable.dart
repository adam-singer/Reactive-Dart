...
//
class _SharedSequenceObservable<T> implements ChainableIObservable<T>, IDisposable, _FactoryObservable{
  Function oFunc;
  IObserver<T> mainObserver;
  final List<IObserver<T>> observers;
  Exception err;
    
  _SharedSequenceObservable(this.oFunc) 
  ...
  IDisposable subscribe(next, [complete(), error(Exception e)]){
    ...
    if (next is Function){
      ...
      var o = new _DefaultObserver(next, complete, error);
      _addObserver(o);
    }
